...
dnf5 install -y mc btop openconnect NetworkManager-openconnect plasma-nm-openconnect git-credential-libsecret lm_sensors korganizer kmail merkuro kdepim-runtime akonadi akonadi-calendar akonadi-calendar-tools kio-gdrive
